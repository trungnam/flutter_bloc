...
import 'package:flutter_app/resources/models/application_error.dart';
import 'package:flutter_app/resources/models/weather_response.dart';
import 'package:flutter_app/resources/config/application_config.dart';
...
//    _dio.inteceptors.response.onSuccess = (Response response) {
//      _logger.fine(
//          "<-- ${response.statusCode} ${response.request.method} ${response.request.path}");
//      String responseAsString = response.data.toString();
//      if (responseAsString.length > maxCharactersPerLine) {
